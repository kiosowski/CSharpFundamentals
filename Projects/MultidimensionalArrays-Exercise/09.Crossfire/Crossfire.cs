...
namespace _09.Crossfire
{
    class Crossfire
    {
        ...
        private static void PrintMatrix(ref List<List<long>> matrix)
        {
        ...
        private static bool TakeInput(ref TargetDetails target)
        {
            ...
            var targetAndRadius = input.Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries)
        ...
        private static void InitMatrix(out List<List<long>> matrix)
        {
            var input = Console.ReadLine()
