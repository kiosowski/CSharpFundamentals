...
namespace _03.WordCount
{
    class WordCount
    {
        ...
        {
            using (var wordsReader = new StreamReader(@"D:\Георги\Software University\CSharpFundamentals\Projects\Streams-Exercise\Resourses\words.txt"))
            {
                using (var textReader = new StreamReader(@"D:\Георги\Software University\CSharpFundamentals\Projects\Streams-Exercise\Resourses\text.txt"))
                {
