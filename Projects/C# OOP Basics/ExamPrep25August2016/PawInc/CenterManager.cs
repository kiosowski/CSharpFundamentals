...
public class CenterManager
{
    ...
    public void RegisterCleasingCenter(string name)
    {
    ...
    public void Cleanse(string cleansingCenterName)
    {
        ...
        var adoptionCenterNames = animals.Select(a => a.AdoptionCenterName).Distinct().ToList();
        foreach (var acn in adoptionCenterNames)
        {
