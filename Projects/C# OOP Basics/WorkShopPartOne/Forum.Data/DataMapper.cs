...
namespace Forum.Data
{
    public class DataMapper
    {
        ...
        public static void SavePosts(List<Post> posts)
        {
            ...
            {
                const string userFormat = "{0};{1};{2};{3};{4}";
                string line = string.Format(userFormat, post.Id, post.Title, post.CategoryId, post.AuthorId, string.Join(",", post.ReplyIds));
                lines.Add(line);
            }
        ...
        public static void SaveReplies(List<Reply> replies)
        {
            ...
            {
                const string userFormat = "{0};{1};{2};{3}";
                string line = string.Format(userFormat, reply.Id,reply.Content,reply.AuthoId,reply.PostId);
                lines.Add(line);
            }
